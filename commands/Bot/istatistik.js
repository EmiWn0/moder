...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const embed = new EmbedBuilder()
      .setTitle("TheStarModeration - İstatistik!")
      .setDescription(`
...
\`\`•\`\` **|** Bellek Kullanımı: **${(process.memoryUsage().heapUsed / 1024 / npm512).toFixed(2)}Mb**
\`\`•\`\` **|** Cpu: **${os.cpus().map(i => `${i.model}`)[0]}**
\`\`•\`\` **|** Discord.JS: **14.11.0**
\`\`•\`\` **|** Geliştirici: <@710080675298148492>
\`\`•\`\` **|** Ortak: <@621340606681055243>
`)
